...
class AddRooms(Frame):
    ...
    def save(self):
        ...
        # Save the room
        result = db_controller.add_room(*[self.data[label].get() for label in ('r_no', 'price', 'type')])
        ...
        if result:
            ...
            messagebox.showerror('Error', 'Unable to add room. Please make sure the data is validated')
