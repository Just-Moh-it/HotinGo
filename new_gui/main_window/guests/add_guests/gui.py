...
class AddGuests(Frame):
    def __init__(self, parent, controller=None, *args, **kwargs):
        ...
        self.parent = parent
        self.data = {'name': StringVar(), 'address': StringVar(), 'phone': StringVar(), 'email': StringVar()}
    ...
    def save(self):
        ...
        # Save the guest
        result = db_controller.add_guest(*[self.data[label].get() for label in ('name', 'address', 'email', 'phone')])
        ...
        if result:
            ...
            messagebox.showerror('Error', 'Unable to add guest. Please make sure the data is validated')
